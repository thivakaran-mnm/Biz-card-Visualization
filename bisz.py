...
mycon=mysql.connector.connect(host="localhost",user="root",password="Thiva@1999",database="Bcards")
...
if select == "Home":
    ...
    if method == "Preview":
        ...
        mycursor.execute("SELECT * FROM bizcard_details")
...
if select == "Delete":
    ...
    with col2:
        mycursor.execute(f"SELECT DESIGNATION FROM bizcard_details WHERE NAME ='{name_select}'")
